...
class Mask_HungarianAssigner(BaseAssigner):
    ...
    def assign(self, mask_pred, gt_mask, gt_bboxes_ignore=None, eps=1e-7):
        ...
        if num_gt == 0 or num_query == 0:
            ...
            if num_gt == 0:
                ...
                assigned_gt_inds[:] = 0
            return AssignResult(num_gt, assigned_gt_inds, None)
